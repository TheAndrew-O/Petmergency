...
public class chokingSmall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choking_small);
    ...
    private void openMenu(View v) {
        PopupMenu popupMenu = new PopupMenu(chokingSmall.this, v);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if(item.getItemId() == R.id.nav_profile){
                    Intent intent = new Intent(chokingSmall.this, ProfileActivity.class);
                    startActivity(intent);
                }
                ...
                if(item.getItemId() == R.id.nav_emergency){
                    Intent intent = new Intent(chokingSmall.this, MainActivity.class);
                    startActivity(intent);
                }
                return false;
            }
