...
public class poison extends AppCompatActivity {
    ...
    private void openMenu(View v) {
        PopupMenu popupMenu = new PopupMenu(poison.this, v);
        popupMenu.getMenuInflater().inflate(R.menu.main_menu, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.nav_appoitments) {
                    Toast.makeText(poison.this, "You Clicked appointments", Toast.LENGTH_SHORT).show();
                }
                ...
                if (item.getItemId() == R.id.nav_emergency) {
                    Intent intent = new Intent(poison.this, MainActivity.class);
                    startActivity(intent);
                }
                return false;
            }
