...
public class BrokenBone extends AppCompatActivity {
    ...
    private void openMenu(View v) {
        PopupMenu popupMenu = new PopupMenu(BrokenBone.this, v);
        popupMenu.getMenuInflater().inflate(R.menu.main_menu, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.nav_appoitments) {
                    Toast.makeText(BrokenBone.this, "You Clicked appointments", Toast.LENGTH_SHORT).show();
                }
                ...
                if (item.getItemId() == R.id.nav_profile) {
                    Intent intent = new Intent(BrokenBone.this, ProfileActivity.class);
                    startActivity(intent);
                }
